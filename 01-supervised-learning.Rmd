...
In practice what we'd like to do is specify a hyperparameter space train `model` objects for certain hyperparameter combinations. The resultant set of models forms a sort of empirical `model family`.
