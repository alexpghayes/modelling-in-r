...
# specify 10-fold CV repeated 10 times as resampling strategy
fitControl <- trainControl(method = "repeatedcv",
                           number = 10,
                           repeats = 10)

# uses grid search on k = [5, 7, 9]
...
Some reasons why `caret` isn't a complete solution in my mind:
...
- It's a nice package to work with, but it probably isn't an API to set as a communal standard for scientists producing packages.
